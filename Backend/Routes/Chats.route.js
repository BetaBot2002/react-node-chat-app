...
import { addToGroup, getAllChatsByUser, getOrCreateSingleChat, newGroupChat, removeFromGroup, renameGroupChat } from '../Controllers/Chat.controller.js'
...
chatRouter.route("/removefromgroup").put(addTokenToRequest,verifyAccessToken,removeFromGroup)
